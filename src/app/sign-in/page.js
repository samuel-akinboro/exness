...
{/* 
                  ...
                  <button type="submit" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-secondary text-black hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 transition-all text-sm focus:ring-offset-gray-800 mt-4">Sign up</button>
                </div>
              </form>
              {/* <!-- End Form --> */}
            </div>
