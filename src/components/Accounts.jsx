          ...
          <div className='bg-[#0F181C] text-white p-4 py-4 rounded-md flex flex-col gap-2 lg:px-8 lg:flex-1 md:rounded-tr-none md:rounded-br-none'>
            ...
            <div className='flex items-center gap-6 my-5 lg:mt-12 lg:mb-8'>
              <div className="group relative">
                ...
                <span className="opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity inline-block absolute invisible z-10 p-4 bg-white text-sm text-black rounded-md shadow-sm w-max top-10 max-w-[90vw] md:max-w-[300px] lg:mt-4" role="tooltip">
              ...
              <div className="group relative">
                ...
                <span className="opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity inline-block absolute invisible z-10 p-4 bg-white text-sm text-black rounded-md shadow-sm w-max max-w-[65vw] top-10 md:max-w-[300px] lg:mt-4" role="tooltip">
          ...
          <div className='bg-gray3 text-textBlack p-4 py-4 rounded-md flex flex-col gap-2 lg:px-8 lg:flex-1 md:rounded-tl-none md:rounded-bl-none'>
            ...
            <div className='flex items-center gap-6 my-5 lg:mt-12 lg:mb-8'>
              <div className="group relative">
                ...
                <span className="opacity-0 group-hover:block group-hover:opacity-100 transition-opacity hidden absolute z-10 p-4 bg-white text-sm text-black rounded-md shadow-sm w-max top-10 max-w-[83vw] md:max-w-[300px] lg:mt-4" role="tooltip">
              ...
              <div className="group relative">
                ...
                <span className="opacity-0 group-hover:block group-hover:opacity-100 transition-opacity hidden absolute z-10 p-4 bg-white text-sm text-black rounded-md shadow-sm w-max max-w-[60vw] top-10 md:max-w-[300px] lg:mt-4 md:-left-28 lg:left-0" role="tooltip">
              ...
              <div className="group relative">
                ...
                <span className="opacity-0 group-hover:block group-hover:opacity-100 transition-opacity absolute hidden z-10 p-4 bg-white text-sm text-black rounded-md shadow-sm w-[50vw] max-w-[65vw] top-10 md:max-w-[300px] lg:mt-4 md:-left-48 lg:left-0" role="tooltip">
