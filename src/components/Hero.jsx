  ...
  return (
    <div className='h-[calc(92vh-56px)] relative md:h-[calc(62vh-56px)] lg:h-[calc(92vh-76px)]'>
      <div className='h-full md:flex lg:w-[92.5%] lg:mx-auto'>
        <div className='text-white flex-col flex h-full px-4 z-10 relative pb-8 md:flex-[0.55] lg:flex-1 md:pl-16 md:pb-8 md:pt-2 lg:pt-8 md:pr-0 md:justify-center'>
          <div className="flex-1 flex flex-col justify-center text-center md:text-left md:flex-initial">
            ...
            <p className='text-lg mt-5 lg:w-3/5 md:mt-8 md:font-light lg:text-lg lg:font-normal'>
              Trade across multiple markets with the most stable and reliable pricing in the industry.
            </p>
          </div>
          <a href="#" target="_blank" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-medium bg-secondary text-black hover:bg-[#FFD938] transition-all duration-400 w-full md:w-fit md:mt-8 lg:mt-12 md:px-6">
              Open account
            </a>
        </div>
        <div className='md:flex-[0.45] lg:flex-1'></div>
      </div>
